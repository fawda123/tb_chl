\documentclass[letterpaper,12pt,oneside]{article}\usepackage{graphicx, color}
...
% latex.default(mod.dat, file = "", rowlabel = "Models", insert.bottom = foot.val,      caption = cap.val, dcolumn = T, caption.loc = "top", rgroup = segs,      n.rgroup = rep(3, 4), n.cgroup = rep(2, 4), cgroup = col.grps,      rowname = mods, colheads = rep(c("Mean", "$\\Delta$ chl-\\textit{a}"),          4), label = "tab:trendest") 
%
\newcolumntype{.}{D{.}{.}{-1}}
\begin{table}[!tbp]
...
{\centering \includegraphics[width=9in]{M:/docs/manuscripts/tb_chl/figs/predobs} 
...
{\centering \includegraphics[width=5in]{M:/docs/manuscripts/tb_chl/figs/hbslice} 
...
{\centering \includegraphics[width=9in]{M:/docs/manuscripts/tb_chl/figs/salnrm} 
...
{\centering \includegraphics[width=9in]{M:/docs/manuscripts/tb_chl/figs/salnrm2} 
...
{\centering \includegraphics[width=8.75in]{M:/docs/manuscripts/tb_chl/figs/beta} 
